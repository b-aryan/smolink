...
const handlSignup = async()=> {
    try{
        ...
        console.log({data});
        errors.value = "Please check your email for verification";
    } catch(err){
    ...
    <section class="h-screen grid place-content-center">
        <div class="container">
            <div class="card">
                ...
                <button class="btn-primary py-5 w-full rounded-full mt-5" @click="handleGithubLogin">
                    Login with Github
                </button>
                ...
                <form @submit.prevent="handleLoginForm">
                    ...
                    <button type ="submit" class="btn-primary w-full py-3 rounded-full mt-3">
                    ...
                    <div class="text-center mt-5">
                        <button type = "button" class="text-center" @click = "isLoggingIn =!isLoggingIn">
                            <template v-if="isLoggingIn">Don't have account? Signup</template>
